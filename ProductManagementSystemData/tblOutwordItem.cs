...
namespace ProductManagementSystemData
{
    ...
    public partial class tblOutwordItem
    {
        public tblOutwordItem()
        {
            this.tblOutwordItemToDiscounts = new HashSet<tblOutwordItemToDiscount>();
            this.tblOutwordItemToTAXes = new HashSet<tblOutwordItemToTAX>();
        }
        ...
        public virtual ICollection<tblOutwordItemToDiscount> tblOutwordItemToDiscounts { get; set; }
        public virtual ICollection<tblOutwordItemToTAX> tblOutwordItemToTAXes { get; set; }
    }
}
